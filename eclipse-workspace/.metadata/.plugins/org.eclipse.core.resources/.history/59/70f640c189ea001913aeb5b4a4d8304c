 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://amdocs.com", wsdlLocation = "http://localhost:8080/HelloSOAPAPI/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://amdocs.com", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloSOAPAPI/services/Hello?wsdl");
    ...
    public Hello getHello() {
        return super.getPort(new QName("http://amdocs.com", "Hello"), Hello.class);
    }
     ...
     */
    @WebEndpoint(name = "Hello")
    public Hello getHello(WebServiceFeature... features) {
        return super.getPort(new QName("http://amdocs.com", "Hello"), Hello.class, features);
    }
