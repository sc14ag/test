...
//		
		...
		int max2 = stream3.reduce(0,(x, y) -> x + y);
		int max3 = numbers.stream().reduce(0,(x,y)->x+y);
		System.out.println("The total is:" +max2);
		numbers.stream().map(value->value+5).forEach(v->System.out.println(v));
